...
public class UserService{
    public static User displayMenu(Scanner scanner, ArrayList<User> users, ArrayList<CreateAccount> createAccounts){
        ...
        switch (choice) {
            case 1 -> LoginService.inputLogin(scanner, users,createAccounts);
            case 2 -> CreateAccountService.inputNewAccount(scanner, users, createAccounts);
            case 3 -> System.exit(0);
            default ->{
                System.out.println("Invalid choice.");
                displayMenu(scanner,users,createAccounts);
            }
        }
        return displayMenu(scanner,users,createAccounts);
    }
